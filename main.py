import sys, os, asyncio, uvicorn, threading, logging, structlog
...
def run_bot_in_thread():
    ...
    try: loop.run_until_complete(start_bot_async())
    finally: loop.close()
...
if __name__ == "__main__":
    ...
    try: uvicorn.run(fastapi_app, host="0.0.0.0", port=port)
    except (KeyboardInterrupt, SystemExit): logger.info("Web server stopped.")